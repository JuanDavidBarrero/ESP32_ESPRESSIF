...
extern const uint8_t client_certicate_start[] asm("_binary_certificates_pem_start");
extern const uint8_t client_certicate_end[] asm("_binary_certificates_pem_end");
...
static void rest_get()
{
    ...
    config_get.url = "https://reqres.in/api/users/2";
    config_get.method = HTTP_METHOD_GET;
    config_get.event_handler = client_event_get_handler;
    config_get.cert_pem = (const char *)client_certicate_start;
...
static void post_rest_function()
{
    ...
    config_post.cert_pem = (const char *)client_certicate_start;
